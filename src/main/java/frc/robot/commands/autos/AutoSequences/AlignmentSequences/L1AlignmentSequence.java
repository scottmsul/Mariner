...
public class L1AlignmentSequence extends SequentialCommandGroup {
    ...
    public L1AlignmentSequence(CoralArm coralArm, AlgaeArm algaeArm, Elevator elevator, SwerveSubsystem swerveSubsystem,
            NTDouble strafeOffset, NTDouble distanceOffset, NTDouble rotationOffset) {
