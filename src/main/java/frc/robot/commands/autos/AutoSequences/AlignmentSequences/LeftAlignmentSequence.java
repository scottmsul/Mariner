...
public class LeftAlignmentSequence extends SequentialCommandGroup {
    ...
    public LeftAlignmentSequence(CoralArm coralArm, AlgaeArm algaeArm, Elevator elevator,
        ...
        var configureAlign = new AutoAlignReef(swerveSubsystem, Constants.SetpointConstants.StrafeOffsets.leftReef,
                Constants.SetpointConstants.DistanceOffsets.reefCoralConfigure, NTD.of(0), NTD.of(0.1), NTD.of(0.1));
        ...
        var scoreAlign = new AutoAlignReef(swerveSubsystem, Constants.SetpointConstants.StrafeOffsets.leftReef,
                Constants.SetpointConstants.DistanceOffsets.leftReefScore, NTD.of(0), NTD.of(0.01), NTD.of(0.02));
