...
public class RobotContainer {
    ...
    DefaultSwerve swerve = new DefaultSwerve(primaryJoy.getHID(),
            swerveSubsystem, elevatorSub);
    ...
    public RobotContainer() {
        ...
        PathPlannerLogging.setLogActivePathCallback(poses -> {
            ...
            Logger.recordOutput("PathFollowing/activePath",
                    poses.toArray(new Pose2d[0]));
        });
        ...
        autoChooser.addOption("left",
                new LeftAuto(coralArm, algaeArm, elevatorSub, swerveSubsystem));
        ...
        autoChooser.addOption("right", new RightAuto(coralArm, algaeArm,
                elevatorSub, swerveSubsystem));
        autoChooser.addOption("goforward", new Forward(swerveSubsystem));
        // autoChooser.addDefaultOption("Do Nothing", Commands.none());
        autoChooser.addOption("Right score once", new RightScoreOnce(coralArm,
                algaeArm, elevatorSub, swerveSubsystem));
        autoChooser.addOption("Left score once", new LeftScoreOnce(coralArm,
                algaeArm, elevatorSub, swerveSubsystem));
        autoChooser.addOption("Center score once left", new CenterScoreOnceLeft(
                coralArm, elevatorSub, algaeArm, swerveSubsystem));
        autoChooser.addOption("Center score once right",
                new CenterScoreOnceRight(coralArm, elevatorSub, algaeArm,
                        swerveSubsystem));
        ...
        autoChooser.addOption("Once center right algae",
                new CenterScoreOnceRightAlgae(coralArm, elevatorSub, algaeArm,
                        swerveSubsystem));
        autoChooser.addOption("Center Right", new CenterAutoRight(coralArm,
                algaeArm, elevatorSub, swerveSubsystem));
        autoChooser.addOption("Center Left", new CenterAutoLeft(coralArm,
                algaeArm, elevatorSub, swerveSubsystem));
        autoChooser.addOption("Left Side once algae", new LeftScoreOnceAlgae(
                coralArm, algaeArm, elevatorSub, swerveSubsystem));
        autoChooser.addOption("Right Side once algae", new RightScoreOnceAlgae(
                coralArm, algaeArm, elevatorSub, swerveSubsystem));
    ...
    public void periodic() {
        ...
        if (results.hasTargets()) {
            ...
            Logger.recordOutput("PhotonBestTarget",
    ...
    private void configureBindings() {
        ...
        primaryJoy.button(3).onTrue(coralArm.intakeCoralCommand())
                .onFalse(coralArm.stopCoralSpin());
        primaryJoy.button(5).onTrue(coralArm.outtakeCoralCommand())
                .onFalse(coralArm.stopCoralSpin());
        primaryJoy.button(4).onTrue(algaeArm.algaeSpinIn())
                .onFalse(algaeArm.algaeSpinStop());
        primaryJoy.button(6).onTrue(algaeArm.algaeSpinOut())
                .onFalse(algaeArm.algaeSpinStop());
        ...
        primaryJoy.button(9).onTrue(climbSub.climbReleaseOverridden())
        ...
        // .onFalse(climbSub.climbStopManual());
        primaryJoy.button(8).onTrue(climbSub.climbOverOverridden())
                .onFalse(climbSub.climbStopManual());
        primaryJoy.button(10).onTrue(Commands
        ...
        var rightBumper = new JoystickButton(secondaryController,
                XboxController.Button.kRightBumper.value);
        var xboxA = new JoystickButton(secondaryController,
                XboxController.Button.kA.value);
        var xboxB = new JoystickButton(secondaryController,
                XboxController.Button.kB.value);
        var xboxX = new JoystickButton(secondaryController,
                XboxController.Button.kX.value);
        var xboxY = new JoystickButton(secondaryController,
                XboxController.Button.kY.value);
        var leftStick = new JoystickButton(secondaryController,
                XboxController.Button.kLeftStick.value);
        var rightStick = new JoystickButton(secondaryController,
        ...
        var xboxStart = new JoystickButton(secondaryController,
                XboxController.Button.kStart.value);
        var xboxBack = new JoystickButton(secondaryController,
        ...
        xboxA.and(leftBumper)
                .onTrue(new ConfigSystem(Constants.SetpointConstants.Options.l1,
                        coralArm, elevatorSub, algaeArm)
                                .alongWith(Commands.print(
                                        "a button and left bumper pressed")));
        xboxB.and(leftBumper)
                .onTrue(new LeftAlignmentSequence(coralArm, algaeArm,
                        elevatorSub, swerveSubsystem,
                        Constants.SetpointConstants.Options.l2));
        xboxX.and(leftBumper)
                .onTrue(new LeftAlignmentSequence(coralArm, algaeArm,
                        elevatorSub, swerveSubsystem,
                        Constants.SetpointConstants.Options.l3));
        xboxY.and(leftBumper)
                .onTrue(new L4AlignmentSequence(coralArm, algaeArm, elevatorSub,
                        swerveSubsystem,
                        Constants.SetpointConstants.StrafeOffsets.leftL4,
                        Constants.SetpointConstants.DistanceOffsets.L4left));
        xboxA.and(rightBumper)
                .onTrue(new ConfigSystem(Constants.SetpointConstants.Options.l1,
                        coralArm, elevatorSub, algaeArm));
        xboxB.and(rightBumper)
                .onTrue(new RightAlignmentSequence(coralArm, algaeArm,
                        elevatorSub, swerveSubsystem,
                        Constants.SetpointConstants.Options.l2));
        xboxX.and(rightBumper)
                .onTrue(new RightAlignmentSequence(coralArm, algaeArm,
                        elevatorSub, swerveSubsystem,
                        Constants.SetpointConstants.Options.l3));
        xboxY.and(rightBumper)
                .onTrue(new L4AlignmentSequence(coralArm, algaeArm, elevatorSub,
                        swerveSubsystem,
                        Constants.SetpointConstants.StrafeOffsets.rightL4,
                        Constants.SetpointConstants.DistanceOffsets.L4Right));
        noBumper.and(hasUpperTarget).and(leftStick)
                .onTrue(new ProcessorAlignmentSequence(coralArm, algaeArm,
                        elevatorSub, swerveSubsystem));
        xboxA.and(noBumper).and(hasAlgae).and(hasUpperTarget.negate())
                .onTrue(new ConfigSystem(
                        Constants.SetpointConstants.Options.processor, coralArm,
                        elevatorSub, algaeArm));
        xboxA.and(noBumper).and(hasAlgae.negate())
                .onTrue(new ConfigSystem(
                        Constants.SetpointConstants.Options.driveConfig,
                        coralArm, elevatorSub, algaeArm));
        xboxB.and(noBumper).and(xboxStart.negate())
                .onTrue(new CoralStationSequence(coralArm, algaeArm,
                        elevatorSub, swerveSubsystem));
        xboxB.and(noBumper).and(xboxStart)
                .onTrue(new ConfigSystem(
                        Constants.SetpointConstants.Options.coralStationManual,
                        coralArm, elevatorSub, algaeArm));
        xboxX.and(noBumper)
                .onTrue(new AlgaeIntakeAlignmentSequence(coralArm, elevatorSub,
                        algaeArm, swerveSubsystem,
                        Constants.SetpointConstants.Options.algaeLow));
        xboxY.and(noBumper)
                .onTrue(new AlgaeIntakeAlignmentSequence(coralArm, elevatorSub,
                        algaeArm, swerveSubsystem,
                        Constants.SetpointConstants.Options.algaeHigh));
        rightStick.and(noBumper)
                .onTrue(new ConfigSystem(
                        Constants.SetpointConstants.Options.algaeGround,
                        coralArm, elevatorSub, algaeArm));
        ...
        // waypoints
        /*
         * Start pressed: Left POV = reef north west Up POV = reef north\ Right POV = reef north
         * east Down POV = coralstation left
         * 
         * Back Pressed: Left POV = reef south west Up POV = reef south Right POV = reef south east
         * Down POV= right coral station
         * 
         * start and left button = processor
         */

        upPOV.and(xboxStart).whileTrue(GoTo.reefN());
        downPOV.and(xboxStart).whileTrue(GoTo.coralStationRight());
        leftPOV.and(xboxStart).whileTrue(GoTo.reefNW());
        rightPOV.and(xboxStart).whileTrue(GoTo.reefNE());
        upPOV.and(xboxBack).whileTrue(GoTo.reefS());
        downPOV.and(xboxBack).whileTrue(GoTo.coralStationLeft());
        leftPOV.and(xboxBack).whileTrue(GoTo.reefSW());
        rightPOV.and(xboxBack).whileTrue(GoTo.reefSE());
        ...
        xboxBack.and(xboxA)
                .onTrue(new ConfigSystem(
                        ...
                        coralArm, elevatorSub, algaeArm));
        xboxBack.and(xboxX)
                .onTrue(new ConfigSystem(Constants.SetpointConstants.Options.l3,
                        coralArm, elevatorSub, algaeArm));
        xboxBack.and(xboxY)
                .onTrue(new ConfigSystem(Constants.SetpointConstants.Options.l4,
                        coralArm, elevatorSub, algaeArm));
    }

    public class MyCommandShouldHaveAName extends SequentialCommandGroup {
        MyCommandShouldHaveAName(CoralArm coralArm, Elevator elevator,
                AlgaeArm algaeArm) {
            ...
            addCommands(
                    ...
                    new ConfigSystem(
                            Constants.SetpointConstants.Options.processor,
                            coralArm, elevatorSub, algaeArm));
    ...
    public Command simple() {
        ...
        return AutoBuilder.pathfindToPose(pose, new PathConstraints(1, 1, 1, 1),
                0);
    }
    ...
    public void setStartingPose() {
        ...
        var selectedStartingPose =
                poseChooserState == null ? StartingPlace.Center
                        : poseChooserState;
        if (GoTo.getAlliance() == Alliance.Red) {
            switch (selectedStartingPose) {
                case Left:
                    swerveSubsystem.resetOmetry(
                            new Pose2d(10, 0.7, new Rotation2d(0.58)));
                    break;
                case Center:
                    swerveSubsystem
                            .resetOmetry(new Pose2d(10, 4, new Rotation2d()));
                    break;
                case Right:
                    swerveSubsystem.resetOmetry(
                            new Pose2d(10, 7.1, new Rotation2d(-0.58)));
                    break;
            }
        } else {
            switch (selectedStartingPose) {
                case Left:
                    swerveSubsystem.resetOmetry(
                            new Pose2d(7.5, 7.3, new Rotation2d(0.58)));
                    break;
                case Center:
                    swerveSubsystem.resetOmetry(
                            new Pose2d(7.5, 4, Rotation2d.k180deg));
                    break;
                case Right:
                    swerveSubsystem.resetOmetry(
                            new Pose2d(7.5, 0.7, new Rotation2d(-0.58)));
                    break;
            }
        }
    }
